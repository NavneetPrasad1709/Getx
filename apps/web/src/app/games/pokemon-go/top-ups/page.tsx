      ...
      <section className="border-b bg-muted/20">
        <div className="container py-8">
          ...
          >
            ...
            <span aria-hidden="true">/</span>
            <span className="text-foreground">Top Ups</span>
          </nav>
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Pokemon GO Top Ups</h1>
          <p className="text-muted-foreground">
            PokéCoins delivered fast. Choose from instant or login-based delivery.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-8">
          ...
          <div>
            ...
            {error && (
              <Card>
                <CardContent className="p-12 text-center">
                  <h2 className="font-semibold text-lg mb-1">Failed to load top ups</h2>
            ...
            {data && data.data.length === 0 && (
              <Card>
                <CardContent className="p-12 text-center">
                  <h2 className="font-semibold text-lg mb-1">No top ups match your filters</h2>
