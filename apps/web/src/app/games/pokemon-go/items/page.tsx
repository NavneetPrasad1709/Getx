    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="border-b bg-muted/20">
        <div className="container py-8">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Pokemon GO Items</h1>
          <p className="text-muted-foreground">
            Pokeballs, berries, potions and curated bundles. Delivered fast.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-8">
          ...
          <div>
            ...
            {error && (
              <Card>
                <CardContent className="p-12 text-center">
                  <h2 className="font-semibold text-lg mb-1">Failed to load items</h2>
            ...
            {data && data.data.length === 0 && (
              <Card>
                <CardContent className="p-12 text-center">
                  <h2 className="font-semibold text-lg mb-1">No items match your filters</h2>
